...
if ( !function_exists( 'leenkme_replacements_args' ) ) {
	 ...
	 * @param int $id User ID
	 */
	function leenkme_replacements_args( $string, $post_title, $excerpt, $include_excerpt = false ) {
			
		$wp_sitename = htmlspecialchars( stripcslashes( strip_tags( get_bloginfo( 'name' ) ) ) );
		$wp_tagline = htmlspecialchars( stripcslashes( strip_tags( get_bloginfo( 'description' ) ) ) );
		...
		$string = htmlspecialchars( stripcslashes( $string ) );
...
if ( !function_exists( 'leenkme_get_picture' ) ) {
	 ...
	 * @param int $id User ID
	 */
	function leenkme_get_picture( $user_settings, $post_id, $type ) {
	
		if ( $user_settings['force_' . $type . '_image'] ) {
			
			$picture = $user_settings['default_image'];
			...
			} else if ( !empty( $user_settings['default_image'] ) ) {
