...
if ( ! class_exists( 'leenkme' ) ) {
	...
	class leenkme {
		...
		function leenkme() {
			...
			add_action( 'admin_print_scripts-post.php', 						array( &$this, 'leenkme_post_scripts' ) );
			add_action( 'admin_print_scripts-edit.php', 						array( &$this, 'leenkme_post_scripts' ) );
			add_action( 'admin_print_scripts-post-new.php', 					array( &$this, 'leenkme_post_scripts' ) );
			add_action( 'admin_print_styles-post.php', 							array( &$this, 'leenkme_post_styles' ) );
			add_action( 'admin_print_styles-post-new.php', 						array( &$this, 'leenkme_post_styles' ) );
			
			add_action( 'admin_print_scripts-toplevel_page_leenkme', 			array( &$this, 'leenkme_plugin_scripts' ) );
			add_action( 'admin_print_styles-toplevel_page_leenkme', 			array( &$this, 'leenkme_plugin_styles' ) );
			add_action( 'admin_print_scripts-leenk-me_page_leenkme_twitter', 	array( &$this, 'leenkme_plugin_scripts' ) );
			add_action( 'admin_print_styles-leenk-me_page_leenkme_twitter', 	array( &$this, 'leenkme_plugin_styles' ) );
			add_action( 'admin_print_scripts-leenk-me_page_leenkme_facebook', 	array( &$this, 'leenkme_plugin_scripts' ) );
			add_action( 'admin_print_styles-leenk-me_page_leenkme_facebook', 	array( &$this, 'leenkme_plugin_styles' ) );
			add_action( 'admin_print_scripts-leenk-me_page_leenkme_friendfeed', array( &$this, 'leenkme_plugin_scripts' ) );
			add_action( 'admin_print_styles-leenk-me_page_leenkme_friendfeed', 	array( &$this, 'leenkme_plugin_styles' ) );
			add_action( 'admin_print_scripts-leenk-me_page_leenkme_linkedin',	array( &$this, 'leenkme_plugin_scripts' ) );
			add_action( 'admin_print_styles-leenk-me_page_leenkme_linkedin', 	array( &$this, 'leenkme_plugin_styles' ) );
		...
		function leenkme_post_styles() {
			
			wp_enqueue_style( 'leenkme_css', $this->base_url . 'css/post.css' );
			
		}
		
		function leenkme_plugin_scripts() {			
		...
		function leenkme_plugin_styles() {
			
			wp_enqueue_style( 'global' );
			wp_enqueue_style( 'dashboard' );
			wp_enqueue_style( 'thickbox' );
			wp_enqueue_style( 'wp-admin' );
			wp_enqueue_style( 'leenkme_css', $this->base_url . 'css/leenkme.css' );
